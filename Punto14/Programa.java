...
public class Programa 
{
	public static void main(String[] args) 
	{
		...
		//Instrucción principal y única.
		System.out.println("Ingrese las notas del primer parcial (-1 para finalizar):");
        int nota = 0;
        
        while(nota != -1) 
        {
            System.out.print("Nota: "); //Entrada de la nota que se repetirá hasta que se ingrese -1.
            ...
            {
                System.out.println("Nota inválida. Debe estar entre 0 y 10. Se repetirá tu pedido de ingreso."); //Si no esta entre 0 y 10 y no es -1. 
